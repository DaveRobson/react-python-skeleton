...
},{"./hello":1,"react":158}],3:[function(require,module,exports){
...
var ReactBrowserEventEmitter = assign({}, ReactEventEmitterMixin, {
   ...
   *
   * @see http://www.quirksmode.org/react-python-skeleton/archives/2010/09/click_event_del.html
   *
      ...
      if (!(
        ...
        if (dependency === topLevelTypes.topWheel) {
          ...
          if (isEventSupported('focus', true)) {
            ...
            // @see http://www.quirksmode.org/react-python-skeleton/archives/2008/04/delegating_the.html
            ReactBrowserEventEmitter.ReactEventListener.trapBubbledEvent(
              topLevelTypes.topFocus,
              'focusin',
              mountAt
 ...
 * (http://www.andismith.com/react-python-skeleton/2012/02/modernizr-prefixed/), an `-ms` prefix
